    ...
    <div className="mx-auto max-w-md sm:max-w-3xl">
      <div>
        <div className="text-center">
          <h2 className="mt-2 text-base font-semibold leading-6 text-white-900">
            Dragon-fly minter
          </h2>
          <p className="mt-1 text-sm text-gray-500">
            Drop or select your collection
          </p>
        </div>
        <Dropzone />
      </div>
      ...
      <div className="mt-10">
        <h3 className="text-sm font-medium text-gray-500">Mint description</h3>
        <form>
...
function Dropzone() {
  ...
  const thumbs = files.map((file) => (
    <div
      className="inline-flex rounded-sm border-white border border-solid mb-2 mr-2 w-[100px] h-[100px] p-1 box-border"
      // @ts-ignore
      key={file.name}
    >
