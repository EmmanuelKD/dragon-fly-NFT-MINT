...
import { loadKeypairFromFile, loadOrGenerateKeypair } from "./index";
...
export const STATIC_PUBLICKEY: PublicKey = new PublicKey(
  "A1bTJx8GnuJgCiRpmjZ8tQpLaNs33iF83k7AHrSgg6WZ"
);
